    ...
    return (
        ...
        >
            <div className="h-full w-full flex flex-col gap-3 justify-center m-auto text-start">
                ...
                >
                    <BuildingOfficeIcon className="text-[#b49bff] mr-[10px] h-5 w-5" />
                ...
                >
                    A platform that provides various attractive promos for travel and vacations, with exclusive offers for flight tickets, hotels, and tour packages.
                </motion.p>
            </div>
            ...
            >
                <Image
                    src="/mockup-masterdiskon.png"
                    alt="Mockup Masterdiskon"
                    height={650}
                    width={550}
