    ...
    return (
        ...
        >
            <div className="h-full w-full flex flex-col gap-3 justify-center m-auto text-start">
                ...
                >
                    <TruckIcon className="text-[#b49bff] mr-[10px] h-5 w-5" />
                ...
                <motion.div
                    ...
                    className="flex flex-col gap-6 mt-6 text-4xl sm:text-4xl font-bold text-white max-w-[400px] sm:max-w-[600px] w-auto h-auto"
                >
                    <span>
                        Website & Apps
                        <br />
                ...
                >
                    A logistics service provider that offers fast, safe, and reliable shipping solutions, backed by a wide network and advanced technology.
                </motion.p>
            </div>
            ...
            >
                <Image
                    src="/mockup-elogs.png"
                    alt="Mockup Eureka Logistic"
                    height={650}
                    width={550}
