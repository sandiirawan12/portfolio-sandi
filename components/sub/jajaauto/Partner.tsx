    ...
    return (
        ...
        >
            <div className="h-full w-full flex flex-col gap-3 sm:justify-center items-center m-auto text-start">
                ...
                >
                    We are supported by various car brands in Indonesia such as Toyota, Honda, Hyundai, BYD, Mitsubishi, Nissan, Daihatsu, etc. Exclusive brands are also available, namely Ferrari, Lamborghini, Porsche, BMW, and Mercedes Benz.
                </motion.p>
            </div>
            <motion.div
