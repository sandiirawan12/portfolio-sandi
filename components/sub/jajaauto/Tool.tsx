        ...
        >
            ...
            >
                <div className="flex flex-row justify-around flex-wrap mt-4 gap-5 md:gap-20 items-center">
                    {tool_masterdiskon.map((image, index) => (
                        <SkillDataProvider
                            key={index}
                            src={image.Image}
                            width={image.width}
            ...
            <div className="h-full w-full flex flex-col gap-3 sm:justify-center items-center m-auto text-start">
                ...
                >
                    The tools used to create application systems are as follows: React JS, Express Js, Javascript, Node JS, Mysql, Google Cloud, Tailwind, Redux, React Native
                </motion.p>
            </div>
        </motion.div>
    );
