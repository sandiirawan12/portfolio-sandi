    ...
    return (
        ...
        >
            ...
            <div className="h-full w-full flex flex-col gap-3 sm:justify-center items-center m-auto text-start">
                ...
                >
                    The tools used to create application systems are as follows: Express Js, Javascript, Node JS, Mysql, Google Cloud, Vue Js, Nuxt Js, Figma
                </motion.p>
            </div>
        </motion.div>
    );
